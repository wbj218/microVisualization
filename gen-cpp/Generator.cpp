...
Generator_run_args::~Generator_run_args() throw() {
}


uint32_t Generator_run_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Generator_run_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Generator_run_args");
...
Generator_run_pargs::~Generator_run_pargs() throw() {
}


uint32_t Generator_run_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Generator_run_pargs");
...
void GeneratorClient::run()
{
  send_run();
}

void GeneratorClient::send_run()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("run", ::apache::thrift::protocol::T_ONEWAY, cseqid);

  Generator_run_pargs args;
  args.write(oprot_);
...
void GeneratorProcessor::process_run(int32_t, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol*, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Generator.run", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Generator.run");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Generator.run");
  }

  Generator_run_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Generator.run", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Generator.run");
    }
    return;
  }

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->asyncComplete(ctx, "Generator.run");
  }
...
void GeneratorConcurrentClient::run()
{
  send_run();
}

void GeneratorConcurrentClient::send_run()
{
  int32_t cseqid = 0;
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("run", ::apache::thrift::protocol::T_ONEWAY, cseqid);
