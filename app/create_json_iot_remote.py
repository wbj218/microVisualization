...
for i in xrange(0,int(sys.argv[2])):
    f.write('	{"edge":"e3","source":"iot.remote.wifiRouter","target":"iot.remote.droneController'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.logJS'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.motionController'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.sensorCameraImage'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.sensorCameraVideo'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.sensorLocation'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.sensorSpeed'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.sensorOrientation'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.droneController'+str(i)+'","target":"iot.remote.sensorLuminosity'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorCameraImage'+str(i)+'","target":"iot.remote.logJS'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorCameraVideo'+str(i)+'","target":"iot.remote.logJS'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorLocation'+str(i)+'","target":"iot.remote.logJS'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorSpeed'+str(i)+'","target":"iot.remote.logJS'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorOrientation'+str(i)+'","target":"iot.remote.logJS'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorLuminosity'+str(i)+'","target":"iot.remote.logJS'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.motionController'+str(i)+'","target":"iot.remote.imageRecognition'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.imageRecognition'+str(i)+'","target":"iot.remote.obstacleAvoidance'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.imageRecognition'+str(i)+'","target":"iot.remote.stockImageDB'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorCameraImage'+str(i)+'","target":"iot.remote.imageRecognition'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorCameraVideo'+str(i)+'","target":"iot.remote.imageRecognition'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorLocation'+str(i)+'","target":"iot.remote.imageRecognition'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorCameraImage'+str(i)+'","target":"iot.remote.obstacleAvoidance'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorCameraVideo'+str(i)+'","target":"iot.remote.obstacleAvoidance'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorLocation'+str(i)+'","target":"iot.remote.obstacleAvoidance'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorSpeed'+str(i)+'","target":"iot.remote.obstacleAvoidance'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorOrientation'+str(i)+'","target":"iot.remote.obstacleAvoidance'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.sensorLuminosity'+str(i)+'","target":"iot.remote.obstacleAvoidance'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
    f.write('	{"edge":"e3","source":"iot.remote.logJS'+str(i)+'","target":"iot.remote.logDB'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
