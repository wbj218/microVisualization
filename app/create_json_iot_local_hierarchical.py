...
for i in xrange(0,int(sys.argv[2])/10):
    f.write('{"node":"iot.local.masterDrone'+str(i)+'","package":"db","timestamp":"2016-04-17T13:46:56.329529972-07:00","metadata":"IP/54.198.0.1"},\n')
...
for i in xrange(0,int(sys.argv[2])/10):
    f.write('{"edge":"e3","source":"iot.local.wifiRouter","target":"iot.local.masterDrone'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')

for i in xrange(0,int(sys.argv[2])):
    f.write('{"edge":"e3","source":"iot.local.masterDrone'+str(int(int(i)/10))+'","target":"iot.local.droneController'+str(i)+'","bidirectional":"yes","timestamp":"2016-04-17T13:46:56.330250819-07:00"},\n')
