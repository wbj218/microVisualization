...
try {   
    ...
    $movie_id_client = new \NetFlixMicroservices\ProcessMovieIDClient($movie_id_protocol);
    ...
    $compose_page_client = new \NetFlixMicroservices\ComposePageClient($compose_page_protocol);
