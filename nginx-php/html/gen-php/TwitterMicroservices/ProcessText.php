...
interface ProcessTextIf {
   ...
   * @param string $type
   */
  public function process_text($req_id, $text_data, $type);
}


class ProcessTextClient implements \TwitterMicroservices\ProcessTextIf {
  ...
  {
    $args = new \TwitterMicroservices\ProcessText_ping_args();
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\TwitterMicroservices\ProcessText_ping_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \TwitterMicroservices\ProcessText_ping_result();
  ...
  public function process_text($req_id, $text_data, $type)
  {
    $this->send_process_text($req_id, $text_data, $type);
  }

  public function send_process_text($req_id, $text_data, $type)
  {
    $args = new \TwitterMicroservices\ProcessText_process_text_args();
    $args->req_id = $req_id;
