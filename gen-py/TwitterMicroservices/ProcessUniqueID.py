...
class Iface(object):
    ...
    def get_unique_id(self, req_id, tweet_type):
        """
        Parameters:
         - req_id
         - tweet_type
...
class Client(Iface):
    ...
    def get_unique_id(self, req_id, tweet_type):
        ...
        Parameters:
         ...
         - tweet_type
        """
        self.send_get_unique_id(req_id, tweet_type)

    def send_get_unique_id(self, req_id, tweet_type):
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["get_unique_id"] = Processor.process_get_unique_id
    ...
    def process_get_unique_id(self, seqid, iprot, oprot):
        args = get_unique_id_args()
        args.read(iprot)
        iprot.readMessageEnd()
        try:
            self._handler.get_unique_id(args.req_id, args.tweet_type)
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except:
            pass
...
class get_unique_id_args(object):
    """
    Attributes:
     - req_id
     - tweet_type
    ...
    thrift_spec = (
        ...
        (2, TType.STRING, 'tweet_type', 'UTF8', None, ),  # 2
    )

    def __init__(self, req_id=None, tweet_type=None,):
        self.req_id = req_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('get_unique_id_args')
        ...
        if self.tweet_type is not None:
            oprot.writeFieldBegin('tweet_type', TType.STRING, 2)
