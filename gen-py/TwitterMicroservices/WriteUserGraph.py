...
class Iface(object):
    ...
    def write_graph(self, user_id, unique_id, req_id):
        """
        Parameters:
         - user_id
         - unique_id
...
class Client(Iface):
    ...
    def write_graph(self, user_id, unique_id, req_id):
        ...
        Parameters:
         ...
         - req_id
        """
        self.send_write_graph(user_id, unique_id, req_id)

    def send_write_graph(self, user_id, unique_id, req_id):
        self._oprot.writeMessageBegin('write_graph', TMessageType.ONEWAY, self._seqid)
        args = write_graph_args()
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["write_graph"] = Processor.process_write_graph
    ...
    def process_write_graph(self, seqid, iprot, oprot):
        args = write_graph_args()
        args.read(iprot)
        iprot.readMessageEnd()
        try:
            self._handler.write_graph(args.user_id, args.unique_id, args.req_id)
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except:
            pass
...
class write_graph_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('write_graph_args')
