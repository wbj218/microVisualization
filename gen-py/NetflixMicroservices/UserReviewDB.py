...
class Iface(object):
    ...
    def write_user_review(self, req_id, movie_id, user_id, unique_id):
        """
        Parameters:
         - req_id
         - movie_id
...
class Client(Iface):
    ...
    def write_user_review(self, req_id, movie_id, user_id, unique_id):
        ...
        Parameters:
         ...
         - unique_id
        """
        self.send_write_user_review(req_id, movie_id, user_id, unique_id)

    def send_write_user_review(self, req_id, movie_id, user_id, unique_id):
        self._oprot.writeMessageBegin('write_user_review', TMessageType.ONEWAY, self._seqid)
        args = write_user_review_args()
        args.req_id = req_id
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["write_user_review"] = Processor.process_write_user_review
    ...
    def process_write_user_review(self, seqid, iprot, oprot):
        args = write_user_review_args()
        args.read(iprot)
        iprot.readMessageEnd()
        try:
            self._handler.write_user_review(args.req_id, args.movie_id, args.user_id, args.unique_id)
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except:
            pass
...
class write_user_review_args(object):
    """
    Attributes:
     - req_id
     - movie_id
    ...
    def __init__(self, req_id=None, movie_id=None, user_id=None, unique_id=None,):
        self.req_id = req_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('write_user_review_args')
