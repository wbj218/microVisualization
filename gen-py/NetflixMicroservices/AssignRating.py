...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["assign_rating"] = Processor.process_assign_rating
    ...
    def process_assign_rating(self, seqid, iprot, oprot):
        args = assign_rating_args()
        args.read(iprot)
        iprot.readMessageEnd()
        try:
...
class assign_rating_args(object):
    """
    Attributes:
     - req_id
     - rating
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('assign_rating_args')
