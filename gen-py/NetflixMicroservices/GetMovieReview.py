...
class Iface(object):
    ...
    def get_movie_review(self, req_id, movie_id, begin_no, num, server_no):
        """
        Parameters:
         - req_id
         - movie_id
...
class Client(Iface):
    ...
    def get_movie_review(self, req_id, movie_id, begin_no, num, server_no):
        ...
        Parameters:
         ...
         - server_no
        """
        self.send_get_movie_review(req_id, movie_id, begin_no, num, server_no)

    def send_get_movie_review(self, req_id, movie_id, begin_no, num, server_no):
...
class Processor(Iface, TProcessor):
    ...
    def process_get_movie_review(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        try:
            self._handler.get_movie_review(args.req_id, args.movie_id, args.begin_no, args.num, args.server_no)
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except:
            pass
...
class get_movie_review_args(object):
    ...
    thrift_spec = (
        ...
        (5, TType.I32, 'server_no', None, None, ),  # 5
    )

    def __init__(self, req_id=None, movie_id=None, begin_no=None, num=None, server_no=None,):
        self.req_id = req_id
    ...
    def write(self, oprot):
        ...
        if self.server_no is not None:
            oprot.writeFieldBegin('server_no', TType.I32, 5)
