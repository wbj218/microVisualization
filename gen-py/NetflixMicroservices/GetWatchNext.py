...
class Iface(object):
    ...
    def get_watch_next(self, req_id, user_id, server_no):
        """
        Parameters:
         - req_id
         - user_id
...
class Client(Iface):
    ...
    def get_watch_next(self, req_id, user_id, server_no):
        ...
        Parameters:
         ...
         - server_no
        """
        self.send_get_watch_next(req_id, user_id, server_no)

    def send_get_watch_next(self, req_id, user_id, server_no):
...
class Processor(Iface, TProcessor):
    ...
    def process_get_watch_next(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        try:
            self._handler.get_watch_next(args.req_id, args.user_id, args.server_no)
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except:
            pass
...
class get_watch_next_args(object):
    ...
    def __init__(self, req_id=None, user_id=None, server_no=None,):
        self.req_id = req_id
