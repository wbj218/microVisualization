...
class Iface(object):
    ...
    def get_thumbnail(self, req_id, movie_id, server_no):
        """
        Parameters:
         - req_id
         - movie_id
...
class Client(Iface):
    ...
    def get_thumbnail(self, req_id, movie_id, server_no):
        ...
        Parameters:
         ...
         - server_no
        """
        self.send_get_thumbnail(req_id, movie_id, server_no)

    def send_get_thumbnail(self, req_id, movie_id, server_no):
        self._oprot.writeMessageBegin('get_thumbnail', TMessageType.ONEWAY, self._seqid)
...
class Processor(Iface, TProcessor):
    ...
    def process_get_thumbnail(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        try:
            self._handler.get_thumbnail(args.req_id, args.movie_id, args.server_no)
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except:
            pass
