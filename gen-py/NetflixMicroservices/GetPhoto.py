...
class Iface(object):
    ...
    def get_photo(self, req_id, movie_id, server_no):
        """
        Parameters:
         - req_id
         - movie_id
...
class Client(Iface):
    ...
    def get_photo(self, req_id, movie_id, server_no):
        ...
        Parameters:
         ...
         - server_no
        """
        self.send_get_photo(req_id, movie_id, server_no)

    def send_get_photo(self, req_id, movie_id, server_no):
        self._oprot.writeMessageBegin('get_photo', TMessageType.ONEWAY, self._seqid)
        args = get_photo_args()
        args.req_id = req_id
...
class Processor(Iface, TProcessor):
    ...
    def process_get_photo(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        try:
            self._handler.get_photo(args.req_id, args.movie_id, args.server_no)
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except:
            pass
