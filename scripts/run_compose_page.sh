...
taskset -c 17 ../bin/MovieInfoStorageServer 0 &
# taskset -c 19 ../bin/MovieInfoStorageServer 1 &
...
# taskset -c 13 ../bin/ComposePageServer 2 &
# taskset -c 15 ../bin/ComposePageServer 3 &
