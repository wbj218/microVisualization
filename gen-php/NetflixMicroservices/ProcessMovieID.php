...
class ProcessMovieIDClient implements \NetflixMicroservices\ProcessMovieIDIf {
  ...
  public function send_get_movie_id($req_id, $url)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'get_movie_id', TMessageType::ONEWAY, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('get_movie_id', TMessageType::ONEWAY, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
