...
interface GetPlotIf {
   ...
   * @return string
   */
  public function get_plot($req_id, $movie_id);
}
...
class GetPlotClient implements \NetflixMicroservices\GetPlotIf {
  ...
  public function get_plot($req_id, $movie_id)
  {
    $this->send_get_plot($req_id, $movie_id);
    return $this->recv_get_plot();
  }

  public function send_get_plot($req_id, $movie_id)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'get_plot', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('get_plot', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_get_plot()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\NetflixMicroservices\GetPlot_get_plot_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \NetflixMicroservices\GetPlot_get_plot_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    ...
    throw new \Exception("get_plot failed: unknown result");
  }
...
class GetPlot_get_plot_result {
  ...
  public function getName() {
    return 'GetPlot_get_plot_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('GetPlot_get_plot_result');
