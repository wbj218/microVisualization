...
public:
    GetPhotoHandler(const int n_movie_info_store);
...
GetPhotoHandler::GetPhotoHandler(const int n_movie_info_store) {
...
void GetPhotoHandler::get_photo(std::string& _return, const std::string& req_id, const std::string& movie_id) {
    if (IF_TRACE)
